    ...
    HashMap<String, Continente> continentes = new HashMap<>();
		...
		try{
			...
			while((line = br.readLine()) != null){
				...
				Continente continente = new Continente(informacion[0], informacion[1], informacion[4], informacion[2], informacion[3], 1);
  ...
  public HashMap<String, Node> leerAeropuertos(HashMap<String, Ciudad> ciudades){
	...
	public int obtenerCapacidad(HashMap<String, Node>aeropuertos, String origen, String destino){
		...
		if(continenteOrigen == continenteDestino){
			if(continenteOrigen == "EUR")return 250;
			else return 300;
		}else{
			return 350;
		}
	...
	public int obtenerTiempo(HashMap<String, Integer> timeZones, Node aeropuertoSalida, String salida, Node aeropuertoLlegada, String llegada){
		int duracion;
